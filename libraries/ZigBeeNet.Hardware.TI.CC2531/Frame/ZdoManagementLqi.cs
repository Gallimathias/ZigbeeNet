...
{
    public class ZdoManagementLqi : TiDongleReceivePacket
    {

        public static ZigBeeApsFrame Create(ZToolMessage packet)
        {
            ZigBeeApsFrame apsFrame = new ZigBeeApsFrame();
            apsFrame.Cluster = ZdoCommandType.GetValueByType(ZdoCommandType.CommandType.MANAGEMENT_LQI_RESPONSE).ClusterId;
